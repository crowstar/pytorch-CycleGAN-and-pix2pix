...
def define_D(input_nc, ndf, which_model_netD,
             n_layers_D=3, norm='batch', use_sigmoid=False, init_type='normal', num_D=1, getIntermFeat=False, gpu_ids=[]):
    netD = None
    norm_layer = get_norm_layer(norm_type=norm)

    if which_model_netD == 'basic':
        netD = MultiscaleDiscriminator(input_nc, ndf, 3, norm_layer, use_sigmoid, num_D, getIntermFeat)
